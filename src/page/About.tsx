...
import SuitImage from '../assets/CEOSHE.jpg';
            ...
            <div className="flex flex-col lg:flex-row gap-12 items-center">
              ...
              >
                ...
                <p className="text-lg text-gray-700 mb-6 leading-relaxed">
                  Adenola Adegbesan is the AI-powered business transformation
                  strategist trusted by Fortune 500 executives, hedge funds, and
                  policymakers. He doesn't just talk about the future—he builds
                  it.
                </p>

                <p className="text-lg text-gray-700 mb-6 leading-relaxed">
                  With a unique blend of expertise in AI, business strategy,
                  finance, and law, Adenola brings a multidisciplinary approach
                  to business transformation that few can match. His InspireEdge
                  AI platform has revolutionized how executives make strategic
                  decisions, providing AI-powered insights that drive measurable
                  business results.
                </p>

                <p className="text-lg text-gray-700 mb-8 leading-relaxed">
                  As a keynote speaker, Adenola is known for his
                  thought-provoking, no-nonsense approach to AI business
                  strategy. His signature keynote, "AI is the iceberg. You
                  either see it and adapt, or you become the Titanic," has been
                  delivered to audiences across five continents.
                </p>
            ...
            >
              <div className="text-center max-w-3xl mx-auto mb-16">
                ...
                <p className="text-lg text-gray-700">
                  Adenola's multidisciplinary expertise enables him to bridge
                  the gap between AI technology and business leadership.
                </p>
              </div>
                ...
                <div className="premium-card p-8">
                  ...
                  <ul className="space-y-3">
                    ...
                    <li className="flex items-start">
                      <span className="text-gold-500 mr-2">•</span>
                      <span className="text-gray-700">
                        AI Consultant for Fortune 500 Executives
                      </span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-gold-500 mr-2">•</span>
                    ...
                    <li className="flex items-start">
                      <span className="text-gold-500 mr-2">•</span>
                      <span className="text-gray-700">
                        International Keynote Speaker on AI Business Strategy
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="premium-card p-8">
                  ...
                  <ul className="space-y-3">
                    ...
                    <li className="flex items-start">
                      <span className="text-gold-500 mr-2">•</span>
                      <span className="text-gray-700">
                        Lean Six Sigma Black Belt – Business Process
                        Optimization
                      </span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-gold-500 mr-2">•</span>
                      <span className="text-gray-700">
                        Former Financial Strategy Consultant for Global
                        Investment Firms
                      </span>
                    </li>
                  </ul>
                ...
                <div className="premium-card p-8">
                  ...
                  <ul className="space-y-3">
                    <li className="flex items-start">
                      <span className="text-gold-500 mr-2">•</span>
                      <span className="text-gray-700">
                        Bar Practicing Certificate – Nigeria Law School
                      </span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-gold-500 mr-2">•</span>
                    ...
                    <li className="flex items-start">
                      <span className="text-gold-500 mr-2">•</span>
                      <span className="text-gray-700">
                        AI Ethics & Governance Policy Advisor
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="flex flex-col md:flex-row items-center gap-8">
                  <div className="w-full md:w-2/3">
                    ...
                    <p className="text-lg text-gray-700 mb-6">
                      ...
                      AI business strategy, digital transformation, and the
                      future of leadership in an AI-first world.
                    </p>
          ...
          <div className="content-container">
            ...
            >
              <div className="text-center max-w-3xl mx-auto mb-12">
                ...
                <p className="text-lg text-gray-700">
                  Highlights from Adenola's speaking engagements, consulting
                  work, and leadership events across the globe.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div className="overflow-hidden rounded-lg shadow-md hover:shadow-xl transition-all duration-300">
                  ...
                  <div className="p-4 bg-white">
                    <p className="text-navy-900 font-medium">
                      Keynote at The Diamond Speakers Academy
                    </p>
                  </div>
                </div>
                ...
                <div className="overflow-hidden rounded-lg shadow-md hover:shadow-xl transition-all duration-300">
                  <img
                    ...
                    className="w-full h-72 object-cover object-top hover:scale-105 transition-transform duration-700"
                  />
                  <div className="p-4 bg-white">
                    <p className="text-navy-900 font-medium">
                      Adenola and Denise Lewis OBE an Olympic Gold Medalist at
          ...
          <div className="content-container">
            <div className="text-center max-w-3xl mx-auto">
              ...
              <p className="text-xl text-platinum-300 mb-8">
                Transform your organization with AI-powered strategic insights
                from a global thought leader.
              </p>
